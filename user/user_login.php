...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "select*from tbl_user where user_email = '{$user_email}' and user_password = '{$user_password}'");
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="contact-style1_form">
                            ...
                            <div class="contact-form">
                                <form id="user_login_form" class="justify-content-center" style="justify-content: center; " method="post">
                                    ...
                                    <div class="row">
                                        <div class="mx-auto col-10 col-md-8 col-lg-6">
                                            <div class="input-box">
                                                <input type="password" name="user_password" value="" placeholder="Password" required> <?php echo $msg; ?>
