...
if ($_POST) {
    ...
    $old_password_query  = mysqli_query($connection, "select * from tbl_user where user_id='{$user_id}'");
    $old_password_db = mysqli_fetch_array($old_password_query);
    if ($old_password_db['user_password'] == $user_old_password) {
        if ($user_new_password == $user_confirm_password) {
            if ($user_old_password == $user_new_password) {
                ...
                $update_query = mysqli_query($connection, "update tbl_user set user_password = '{$user_new_password}' where user_id='{$user_id}'");
                    ...
                    <div class="col-xl-12">
                        <div class="contact-style1_form">
                            ...
                            <div class="contact-form">
                                <form id="user_change_password_form" class="justify-content-center" style="justify-content: center; " method="post">
                                    <div class="row">
                                        <div class="mx-auto col-10 col-md-8 col-lg-6">
                                            <div class="input-box">
                                                <input type="text" name="user_old_password" placeholder="Enter Old Password" required="">
                                    ...
                                    <div class="row">
                                        <div class="mx-auto col-10 col-md-8 col-lg-6">
                                            <div class="input-box">
                                                <input type="password" name="user_new_password" placeholder="Enter New Password" required="">
                                                <div class="icon"><span class="fa fa-key"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mx-auto col-10 col-md-8 col-lg-6">
                                            <div class="input-box">
                                                <input type="password" name="user_confirm_password" placeholder="Enter Confirm Password" required="">
                                                <div class="icon"><span class="fa fa-key"></span></div>
                                            </div>
                                        </div>
                                    </div>
