...
$blog_query = mysqli_query($connection, "select * from tbl_blog where blog_id = '{$blog_id}'");
                    ...
                    <div class="col-xl-8">
                        <div class="cause-details_content">
                            <div class="cause-details-image-box">
                                <img src="/project/admin/uploads/<?php echo $blog_data['blog_photo']; ?> " alt="">
                            ...
                            <div class="donate-form-box donate-form-box--style2">
                                <div class="top-title">
                                    ...
                                    <p><?php echo $blog_data['blog_details']; ?>
                                    </p>
                                </div>
