...
$child_query = mysqli_query($connection, "select * from tbl_child where child_id = '{$child_id}'");
$child_data = mysqli_fetch_array($child_query);

$ngo_query = mysqli_query($connection, "select * from tbl_ngo where ngo_id ='{$child_data['ngo_id']}'");
                    ...
                    <div class="col-xl-8">
                        <div class="cause-details_content">
                            <div class="cause-details-image-box">
                                <img src="/project/admin/uploads/<?php echo $child_data['child_photo']; ?>" alt="">
                            </div>
