        ...
        <section class="cause-details-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="tile">
                            <h3 class="tile-title" style="color:chocolate">Feedback Information</h3>
                            <br>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['delete_id'])) {
                                        ...
                                        if ($data) {
                                            echo "<script>alert('Feedback removed.');window.location='user_my_feedback.php'</script>";
                                        } else {
                                            echo "<script>alert('Feedback not removed');window.location='user_my_feedback.php'</script>";
                                        }
                                    }

                                    $select = mysqli_query($connection, "select*from tbl_feedback where user_id='{$user_id}'");
                                    while ($feedback_row = mysqli_fetch_array($select)) {
                                        ...
                                        echo "<td>
                                <a href='user_my_feedback.php?delete_id={$feedback_row['feedback_id']}' 
                                onclick='return confirmDelete()' style='color:green;'>
                                <i class='fa fa-trash' aria-hidden='true'></i></a>|  
                                <a href='user_my_feedback_edit.php?edit_id={$feedback_row['feedback_id']}' style='color:green;'> <i class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   
                                </td>";
                                        echo "</tr>";
                                    }
                                    ?>
