...
if ($_POST) {
    ...
    $child_photo_tmp_name = $_FILES['volunteer_photo']['tmp_name'];

    $query = mysqli_query($connection, "insert into tbl_child(ngo_id,child_name,child_gender,child_age,child_photo) values('{$ngo_id}','{$child_name}','{$child_gender}','{$child_age}','{$child_photo_name}')");
    move_uploaded_file($child_photo_tmp_name, "uploads/" . $child_photo_name);
    if ($query) {
        echo "<script>alert('Child added');window.location='child_form.php'</script>";
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" method="post" id="child_from_js">
                            <div class="mb-3 col-md-3">
                                ...
                                <input class="form-control" type="text" name="child_age" placeholder="Enter child age" min="1" max="25" required>
                                <br>
