...
--
-- Host: localhost
-- Generation Time: Mar 01, 2024 at 10:59 AM
...
(2, 'Drashti', 'sdp.project.2024@gmail.com', '1234');
...
(1, 1, 'Nirav', 'Male', '1 year old', 'child_nirav.jpg'),
(2, 1, 'Het', 'Male', '3 Years old', 'child_het.jpg'),
(3, 4, 'Dev', 'Male', '2 Months old', 'child_dev.jpg'),
(4, 1, 'Aarya', 'Female', '5 Year', 'child_aarya.jpg'),
...
(11, 1, 3, 9, '10 clothes for girls', NULL, 'item', '2024-02-29', 'B12,Himavan Appartment,near.Nandan Park,Bopal,Ahmedabad', 'pending', NULL, NULL),
...
(7, 8, 'Can I make a donation by cheque?', 'Yes, absolutely! We welcome donations made by check. Please make your check payable to [NGO Name] and include any specific designation or purpose in the memo line if applicable. You can mail your donation to our mail address.'),
...
(2, 'Drashti', 'Lil', 'drashti@gmail.com', '123', 'Female', 9054568018, '17,Shiv Shakti Society,Opp.Uimya Dairy,Jivraj Park,Ahmedabad', 380051, 9),
(3, 'Mukesh', 'Kumawat', 'sdp.project.2024@gmail.com', '1234', 'Male', 7043138974, 'B12,Himavan Appartment,near.Nandan Park,Bopal,Ahmedabad', 380058, 1),
...
(1, 'Ayushi', 'Patel', 'patelayushi@gmail.com', 'ayuship12', 'Female', 6709345609, 'B05,vidhya Appartment,Ramdev Nagar, ISRO Colony Rd, near Super Society, Satellite, Ahmedabad', 'ayushi_patel.jpg', 'Yes'),
...
--
ALTER TABLE `tbl_item_requirement`
  MODIFY `item_requirement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
