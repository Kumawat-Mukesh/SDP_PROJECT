...
if ($_POST) {
    ...
    $old_password_query  = mysqli_query($connection, "select * from tbl_admin where admin_id='{$admin_id}' and admin_password ='{$old_password}'");
    ...
    if ($old_password_db['admin_password'] == $old_password) {
        if ($new_password == $confirm_pass) {
            if ($old_password == $new_password) {
                ...
                echo "<script>alert('Password Changed');window.location='dashboard.php';</script>";
            }
        } else {
