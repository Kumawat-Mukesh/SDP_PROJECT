...
if ($_POST) {
    ...
    $donation_method = $_POST['donation_method_id'];
    $donation_type = $_POST['donation_type_id'];
    ...
    $query = mysqli_query($connection, "insert into tbl_donation(ngo_id,user_id,item_requirement_id,donation_details,donation_method,donation_type,donation_date,donation_address,donation_status,volunteer_id,donation_amount) values('{$ngo_id}','{$user_id}','{$item_requirement_id}','{$donation_details}','{$donation_method}','{$donation_type}','{$donation_date}','{$donation_address}','{$donation_status}','{$volunteer_id}','{$donation_amount}')");
    if ($query) {
                    ...
                    <div class="tile-body">
                        <form method="post" class="row" id="donation_form_js">
                            <div class="mb-3 col-md-3">
                                ...
                                <!-- <input class="form-control" type="text" name="item_requirement_id" placeholder="Enter Requirement ID" required> -->
                                <select class='form-control' name='donation_method_id'>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <select class='form-control' name='donation_type_id'>
