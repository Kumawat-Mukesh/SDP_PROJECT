<header class="app-header"><a class="app-header__logo" href="dashboard.php">Connecting Dots</a>
  ...
  <ul class="app-nav">
    ...
    <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
      <ul class="dropdown-menu settings-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="admin_setting.php"><i class="bi bi-gear me-2 fs-5"></i> Change Password</a></li>
        
        <li><a class="dropdown-item" href="admin_logout.php" onclick="logout()" ><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
      </ul>
    </li>
  </ul>
</header>
